...
## 1) Later, rewrite some of the more advanced Data Experiments (particularly 1, 7-8) as R Notebooks
# to better facilitate their eventual dissemination
