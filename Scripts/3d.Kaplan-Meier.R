...
(gsurv1c_a <- ggsurvplot(kmPerf_default_real_spell1c, fun="pct", conf.int=T, legend="none", 
                         break.time.by=round(max(kmPerf_default_real_spell1c$time)/8), palette=col.v,
...
haz_dat <- data.table(Time=kmPerf_default_real_spell1c$time, AtRisk_n=kmPerf_default_real_spell1c$n.risk, 
                      ...
                      CumulHazard = kmPerf_default_real_spell1c$cumhaz, Group="1",
                      Surv_KM = kmPerf_default_real_spell1c$surv) %>% 
...
all.equal(haz_dat$CumulHazard, haz_dat$CumulHazard_Disc)
...
ggsave(print(gsurv1c_a,newpage=F), file=paste0(graphPath_real,"/SurvFig1c_a-Default_Surv-KaplanMeier-SpellLevel-MultiSpell-LatentComp-InclLeftTrunc_Correct.png"),width=1200/dpi, height=1000/dpi,dpi=dpi)
ggsave(print(gsurv1c_b,newpage=F), file=paste0(graphPath_real,"/SurvFig1c_b-Default_CumulEvent-KaplanMeier-SpellLevel-MultiSpell-LatentComp-InclLeftTrunc_Correct.png"),width=1200/dpi, height=1000/dpi,dpi=dpi)
ggsave(print(gsurv1c_c,newpage=F), file=paste0(graphPath_real,"/SurvFig1c_c-Default_CumulHaz-NelsonAalen-SpellLevel-MultiSpell-LatentComp-InclLeftTrunc_Correct.png"),width=1200/dpi, height=1000/dpi,dpi=dpi)
dpi <- 140 # reset
ggsave(gsurv1c_d, file=paste0(graphPath_real,"/SurvFig1c_d-Default_Hazard-KaplanMeier-SpellLevel-MultiSpell-LatentComp-InclLeftTrunc_Correct.png"),width=1200/dpi, height=1000/dpi,dpi=dpi)
